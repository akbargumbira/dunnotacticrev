 ...
 * @author ifan
 */
public class Sp2_IfritRage extends Special {
    public Sp2_IfritRage(){
    ...
    public void ExecuteSpecial(CharAtribut KarakterAtribut, Vector<CharAtribut> TargetAtribut){
        ...
        for(int i=0;i<TargetAtribut.size();++i){
            ...
            if(r.nextInt(100)<Chance) {
                ...
                int damage=(int)((double)(KarakterAtribut.GetCurrent(Constanta.MATTACK_ID)-temp.GetCurrent(Constanta.MDEF_ID))*6.0*(double)randFactor)/100;

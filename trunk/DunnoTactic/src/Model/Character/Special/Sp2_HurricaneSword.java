 ...
 * @author ifan
 */
public class Sp2_HurricaneSword extends Special {
    public Sp2_HurricaneSword(){
    ...
    public void ExecuteSpecial(CharAtribut KarakterAtribut, Vector<CharAtribut> TargetAtribut){
        ...
        for(int i=0;i<TargetAtribut.size();++i){
            ...
            if(r.nextInt(100)<Chance) {
                ...
                int damage=(int)((double)(KarakterAtribut.GetCurrent(Constanta.ATTACK_ID)-temp.GetCurrent(Constanta.DEF_ID))*5.0*(double)randFactor)/100;

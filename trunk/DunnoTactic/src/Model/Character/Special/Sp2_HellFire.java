 ...
 * @author ifan
 */
public class Sp2_HellFire extends Special {
    public Sp2_HellFire(){
        ...
        CharAtribut temp = new CharAtribut();
         for(int i=0;i<TargetAtribut.size();++i){
            ...
            if(r.nextInt(100)<Chance) {
                ...
                int damage=(int)((double)(KarakterAtribut.GetCurrent(Constanta.MATTACK_ID)-temp.GetCurrent(Constanta.MDEF_ID))*5.0*(double)randFactor)/100;
